...
%									%
%-----------------------------------%
\includepdf[pages=1,scale=0.95,pagecommand = \section{Enunciado del trabajo práctico}\label{enunciado},offset=10 -10]{includes/tp0-2018-2q.pdf}
\includepdf[pages={2-last},scale=0.95,pagecommand = {},offset=10 -10]{includes/tp0-2018-2q.pdf}
%-----------------------------------%
%									%
%		Seccion:Objetivos			%
%									%
...
\lstinputlisting[language=C, style=StyleC]{src/common.h}
\clearpage

\subsubsection{decoder.h}\label{app_decoderH}
\lstinputlisting[language=C, style=StyleC]{src/decoder.h}
\clearpage

\subsubsection{decoder.c}\label{app_decoder}
\lstinputlisting[language=C, style=StyleC]{src/decoder.c}
\clearpage

\subsubsection{encoder.h}\label{app_encoderH}
\lstinputlisting[language=C, style=StyleC]{src/encoder.h}
\clearpage

\subsubsection{encoder.c}\label{app_encoder}
\lstinputlisting[language=C, style=StyleC]{src/encoder.c}
\clearpage

\subsubsection{parser.h}\label{app_parserH}
\lstinputlisting[language=C, style=StyleC]{src/parser.h}
\clearpage

\subsubsection{parser.c}\label{app_parser}
\lstinputlisting[language=C, style=StyleC]{src/parser.c}
\clearpage

\subsubsection{messages.h}\label{app_messages}
\lstinputlisting[language=C, style=StyleC]{src/messages.h}
\clearpage

\subsubsection{main.s}\label{app_main_asm}
\lstinputlisting[language=C, style=StyleC]{src/src_asmMIPS32/main.s}
\clearpage

\subsubsection{parser.s}\label{app_parser_asm}
\lstinputlisting[language=C, style=StyleC]{src/src_asmMIPS32/parser.s}
\clearpage

\subsubsection{encoder.s}\label{app_encoder_asm}
\lstinputlisting[language=C, style=StyleC]{src/src_asmMIPS32/encoder.s}
\clearpage

\subsubsection{decoder.s}\label{app_decoder_asm}
\lstinputlisting[language=C, style=StyleC]{src/src_asmMIPS32/decoder.s}
\clearpage
